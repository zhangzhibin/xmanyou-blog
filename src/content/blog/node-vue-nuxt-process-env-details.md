...
<!--kg-card-begin: markdown--><h2 id="1nodejsprocessenv">1. Node.js的环境变量对象 process.env</h2>
<blockquote>
...
<h2 id="3nuxtjs">3. Nuxt.js项目的环境变量</h2>
...
<h4 id="1publicruntimeconfig">1). 公有配置 publicRuntimeConfig 字段</h4>
...
<h4 id="2privateruntimeconfig">2). 私有配置 privateRuntimeConfig 字段</h4>
...
<h3 id="33modules">3.3. 模块Modules的参数配置</h3>
