...
<h3 id="usrlocaletcdnsmasqconf">/usr/local/etc/dnsmasq.conf 配置文件完整示例</h3>
```ini
# 严格按照/etc/resolv.conf文件指定的dsn解析器的顺序进行解析
strict-order
# 服务监听地址，设置为127.0.0.1仅限本机使用
