---
title: "macOS技巧：Finder中打开特殊文件夹"
description: "Shift + Command + g 前往任意文件夹"
pubDate: 2020-02-24T09:05:15.000Z
author: "阿斌"
tags: ["杂七杂八", "mac"]
tagSlugs: ["za-qi-za-ba", "mac"]
draft: false
type: post
slug: "macos-finder-goto-folder-short-key"
authorSlug: "dev"
---

<!--kg-card-begin: markdown--><h2 id="">问题背景</h2>
<p>macOS中，Finder（中文名：访达）是一个类似Windows的文件浏览器的应用，通常我们使用这个应用来查看文件。</p>
<p>但是，与Windows不同是，Finder中，很多文件夹默认不显示的（即使不是隐藏文件），比如系统文件夹，再比如应用的内容。</p>
<p>那么，除了万能的命令行外，有什么办法呢？</p>
<h2 id="">解决方法</h2>
